...
public class GroupYouInAdapter extends RecyclerView.Adapter<GroupYouInAdapter.ViewHolder> {

    private Context context;
    private ArrayList<GroupYouIn> arrayList;
    private JoinClickListener joinClickListener;

    public GroupYouInAdapter(Context context, ArrayList<GroupYouIn> arrayList, JoinClickListener joinClickListener) {
...
//        }
    ...
    public void filterList(ArrayList<GroupYouIn> filteredList) {
