...
public class GroupCategoryWiseAdapter extends RecyclerView.Adapter<GroupCategoryWiseAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_group_you_in, viewGroup, false);
...
//        }
        ...
        boolean isMember=arrayList.get(i).isIsMember();
        if (isMember) {
        ...
        viewHolder.btnInvite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               joinClickListener.onJoinClick(arrayList.get(i).isIsMember()+"", arrayList.get(i).getGroupId(),i);
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.startActivity(new Intent(context, GroupPageActivity.class).putExtra("group_id",arrayList.get(i).getGroupId()));
            }
        });
    ...
    public void filterList(ArrayList<CategoryWiseGroup> filteredList) {
