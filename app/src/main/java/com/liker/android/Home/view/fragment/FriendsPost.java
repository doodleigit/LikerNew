 ...
 */
public class FriendsPost extends Fragment   {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ((Home) getActivity()).friendTabClickListener = new TabClickListener() {
            @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mCallback=new TextHolder.PostItemListener() {
            ...
            public void deletePost(PostItem postItem, int position) {
                ...
                FriendsPost.this.deletePost(deletePostItem, deletePosition);
            }
        };
...
//                                adapter.deleteItem(deletePosition);
    ...
    private void getData() {
        ...
        if (NetworkHelper.hasNetworkAccess(getContext())) {
            ...
            Call<List<PostItem>> call = webService.feed(deviceId, profileId, token, userIds, limit, offset, "friends", catIds, filter, false, isWithInTime);
